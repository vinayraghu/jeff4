<?php
 ...
 if (have_comments()) : ?>
  <section id="comments">
    <h3><?php printf(_n('One Response to &ldquo;%2$s&rdquo;', '%1$s Comments to &ldquo;%2$s&rdquo;', get_comments_number(), 'roots'), number_format_i18n(get_comments_number()), get_the_title()); ?></h3>
...
<?php if (comments_open()) : ?>
  <section id="respond">
    <h3><?php comment_form_title(__('Leave your Response', 'roots'), __('Leave your Response to %s', 'roots')); ?></h3>
    ...
    <?php else : ?>
      <form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
        ...
        <textarea name="comment" id="comment" class="input-xlarge span12" rows="5" aria-required="true"></textarea>
        <p><input name="submit" class="btn btn-read-more read-more" type="submit" id="submit" value="<?php _e('Submit Comment', 'roots'); ?>"></p>
